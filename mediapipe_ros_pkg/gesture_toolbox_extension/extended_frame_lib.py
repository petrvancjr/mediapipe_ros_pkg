...
class CustomHand(Hand):
    ...
    def import_from_landmarks(self, is_left, hand):
        ...
        self.fingers = [CustomFinger([hand[0], *hand[1:5]]),
                        CustomFinger([hand[0], *hand[5:9]]),
                        CustomFinger([hand[0], *hand[9:13]]),
                        CustomFinger([hand[0], *hand[13:17]]),
                        CustomFinger([hand[0], *hand[17:21]])]
